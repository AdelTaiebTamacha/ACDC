...
class Cabin():
    ...
    def __init__(self, n_pax_ref = None,
        ...
        """
        Constructor :
            :param n_pax_ref: Uu int - OoM 10^2 - Reference Number of passengers (most often 2 class layout)
            ...
            :param width: Uu m - OoM 10^0 - Maximum width of the cabin (not floor width)
            :param length: Uu m - OoM 10^1 - Total length of the cabin
            :param floor_area: Uu m2 - OoM 10^2 - Area of the cabin taking into account its maximum width (not real floor area)
...
class Payload():
    """
    Authorized positions of the center of gravity
    """
...
class Fuselage():
    ...
    def __init__(self, width = None,
        ...
        Constructor :
            ...
            :param mass: Uu kg - OoM 10^3 - Equiped fuselage mass (without systems)
...
class Wing():
    ...
    def __init__(self, attachment = None,
        ...
        Constructor :
            ...
            :param t_o_c_k: Uu % - OoM 10^1 - Thickness over choerd ratio of the wing at main kink
            ...
            :param mass: Uu kg - OoM 10^3 - Equiped wing mass (without systems)
...
class Tanks():
    ...
    def __init__(self, cantilever_volume = None,
        ...
        Constructor :
            ...
            :param body_volume: Uu m3 - OoM 10^1 - Volume of tanks in the nacelle bodies
            ...
            :param fuel_body_cg: Uu m - OoM 10^1 - Center of gravity of tanks in the nacelle bodies
...
class LandingGears():
    """
    Landing gear mass characteristics
    """
...
class HorizontalTail():
    ...
    def __init__(self, attachment = None,
        ...
        Constructor :
            ...
            :param sweep: Uu deg - OoM 10^0 - Horizontal tail sweep angle at 25% of th echords
            ...
            :param mass: Uu kg - OoM 10^2 - Equiped mass of the horizontal tail
            :param c_g: Uu m - OoM 10^1 - Longitudinal position of the CG of the horizontal tail
            :param x_axe: Uu m - OoM 10^1 - Longituidinal position of the horizontal tail central chord         
...
class VerticalTail():
    """
    Vertical tail plane characteristics
    """
    def __init__(self, sweep = None,
        ...
        """
        Constructor :
            :param sweep: Uu deg - OoM 10^0 - Vertical tail sweep angle at 25% of th echords
            ...
            :param mass: Uu kg - OoM 10^2 - Equiped mass of the vertical tail
            :param c_g: Uu m - OoM 10^1 - Longitudinal position of the CG of the vertical tail
            :param x_root: Uu m - OoM 10^1 - 
            :param x_root: Uu m - OoM 10^2 - Longituidinal position of the vertical tail root chord           
