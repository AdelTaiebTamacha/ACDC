...
#--------------------------------------------------------------------------------------------------------------------------------
class PowerElectricChain():
    """
    Electric chain characteristics
    """
    def __init__(self, mto = None,
                       ...
                       c_g = None):
        """
            :param mto: Uu uc - OoM 10^0 - Tale off power, mto<1: turbofan shat power ratio off take, mto>1: e-fan motor power
            :param mcn: Uu uc - OoM 10^0 - Maxi continuous power, mcn<1: turbofan shat power ratio off take, mcn>1: e-fan motor power
            :param mcl: Uu uc - OoM 10^0 - Max climb power, mcl<1: turbofan shat power ratio off take, mcl>1: e-fan motor power
            :param mcr: Uu uc - OoM 10^0 - Max cruise power, mcr<1: turbofan shat power ratio off take, mcr>1: e-fan motor power
            :param fid: Uu uc - OoM 10^0 - Flight idle power, fid<1: turbofan shat power ratio off take, fid>1: e-fan motor power
...
#--------------------------------------------------------------------------------------------------------------------------------
class ElectricNacelle():
    """
    Electric nacelle characteristics
    """
    def __init__(self, width = None,
                       ...
                       controler_efficiency = None,
                       controler_pw_density = None,
        ...
        Constructor :
            ...
            :param controler_efficiency: Uu no_dim - OoM 10^0 - Controler electric efficiency
            :param controler_pw_density: Uu kW/kg - OoM 10^0 - Power density of controlers
            :param motor_pw_density: Uu kW/kg - OoM 10^0 - Power density of electric motor
            :param nacelle_pw_density: Uu kW/kg - OoM 10^0 - Power density of efan nacelle and mountings
            :param hub_width: Uu m - OoM 10^0 - Diameter of the hub of the electric fan
            :param nozzle_area: Uu m2 - OoM 10^0 - Exhaust nozzle area of the e fan
            :param body_length: Uu m - OoM 10^0 - Length of the body behind the e fan
            :param bnd_layer: Uu structure - OoM 10^0 - Boundary layer thickness law in front of the e-fan, 2darray
        ...
        self.controler_efficiency = controler_efficiency
        self.controler_pw_density = controler_pw_density
...
class ElectricEngine():
    ...
    def __init__(self, mto_e_power_ratio = None,
        ...
        Constructor :
            ...
            :param mcn_e_power_ratio: Uu no_dim - OoM 10^0 - Turbofan off take power ratio maxi continuous rating (one engine), Required ceiling altitude, ISA, half cruise Mach
