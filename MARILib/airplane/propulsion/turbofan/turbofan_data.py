...
class TurbofanPylon():
    """
    Turbofan pylon mass characteristics
    """
...
class TurbofanNacelle():
    ...
    def __init__(self, attachment = None,
        ...
        Constructor
            ...
            :param x_ext: Uu m - OoM 10^1 - Longitudinal position of the center of the air inlet of the external engine
            :param y_ext: Uu m - OoM 10^1 - Span wise position of the center of the air inlet of the external engine
            :param z_ext: Uu m - OoM 10^0 - Vertical position of the center of the air inlet of the external engine
            :param x_int: Uu m - OoM 10^1 - Longitudinal position of the center of the air inlet of the internal engine
            :param y_int: Uu m - OoM 10^1 - Span wise position of the center of the air inlet of the internal engine
            :param z_int: Uu m - OoM 10^0 - Vertical position of the center of the air inlet of the internal engine
            ...
            :param fan_width: Uu m - OoM 10^0 - Diameter of the electric fan
            :param nozzle_width: Uu m - OoM 10^0 - Diameter of the nozzle of the electric fan
...
class TurbofanEngine():
    ...
    def __init__(self, n_engine = None,
        ...
        """
        Constructor :
            :param n_engine: Uu int - OoM 10^0 - Number of turbofans
            :param bpr: Uu no_dim - OoM 10^0 - By Pass Ratio of the turbofans
            :param reference_thrust: Uu daN - OoM 10^4 - Design Reference Thrust of the engines
            :param rating_factor: Uu int - OoM 10^0 - Array of rating factors versus maximum thrust
