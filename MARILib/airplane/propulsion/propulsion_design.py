...
from MARILib.airplane.propulsion.turboprop.turboprop_design \
    import eval_turboprop_nacelle_design, eval_turboprop_engine_design, \
           eval_turboprop_pylon_mass, eval_turboprop_nacelle_mass
...
from MARILib.airplane.propulsion.hybrid_pte2.hybrid_pte2_design \
    import eval_hybrid_turbofan_engine_design, eval_hybrid_body_nacelle_design, \
           eval_hybrid_body_nacelle_mass, eval_body_tank_data, eval_body_battery_cg
...
def eval_propulsion_mass(aircraft):
    ...
    if (propulsion.architecture==1):
        ...
        eval_turbofan_pylon_mass(aircraft)
        eval_hybrid_body_nacelle_mass(aircraft)
        ...
        eval_turboprop_pylon_mass(aircraft)
...
def eval_tank_data(aircraft):
    ...
    if (propulsion.architecture==3):
        ...
        elif (propulsion.fuel_type==2):
            eval_body_tank_data(aircraft)
        else:
            raise Exception("propulsion.fuel_type index is out of range")
