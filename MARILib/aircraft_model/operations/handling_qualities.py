...
def forward_cg_stall(aircraft,altp,disa,nei,hld_conf,speed_mode,mass):
    ...
    [cz_max_wing,cz0] = craft_aero.high_lift(wing, hld_conf)     # Wing maximum lift coefficient without margin
    ...
    cx_basic,lod_trash = craft_aero.drag(aircraft,pamb,tamb,mach,cz_max_wing)    # By definition of the drag_ function
