...
def n_pax_front(n_pax_ref):
    ...
    elif(n_pax_ref<=100): n_pax_front_i = 5
...
def wing_span(wing_area,wing_aspect_ratio):
    wing_span_i = math.sqrt(wing_area*wing_aspect_ratio)
    return wing_span_i
...
#===========================================================================================================
def nacelle_attachment():
    nacelle_attachment_i = 1     # 1: underwing, 2: on rear fuselage
...
#===========================================================================================================
def controler_efficiency():
    controler_efficiency_i = 0.98    # no_dim
    return controler_efficiency_i
...
def generator_power_density():
    generator_power_density_i = 5e3    # W/kg, Electric generator
...
def cooling_pw_density():
    cooling_pw_density_i = 10e3    # W/kg, Cooling
    return cooling_pw_density_i

#===========================================================================================================
def controler_pw_density():
    controler_pw_density_i = 20e3    # W/kg, Electric motor
    return controler_pw_density_i

#===========================================================================================================
def e_motor_pw_density():
    e_motor_pw_density_i = 5e3    # W/kg, Electric motor
...
def htp_attachment():
    """
    htp_attachment = 1 : Classical (on rear fuselage)
    htp_attachment = 2 : T-tail (on top of fin)
    """
    htp_attachment_i = 1
...
#===========================================================================================================
def cas1_ttc(propulsive_architecture):
    if (propulsive_architecture==1):
        ...
        cas1_ttc_i = unit.mps_kt(150)
    else:
        raise Exception("propulsion.architecture index is out of range")
    return cas1_ttc_i

#===========================================================================================================
def cas2_ttc(propulsive_architecture):
    if (propulsive_architecture==1):
...
def cost_mission_range(design_range):
    if(design_range < unit.m_NM(4500)): cost_mission_range_i = unit.m_NM(500)
