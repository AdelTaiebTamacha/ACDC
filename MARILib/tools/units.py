...
def kt_mps(mps): return mps/1852*3600   # Translate meters per second into knots
...
#=========================================================================================================================================
def smart_round(X,S):
	Fac = (10*numpy.ones(S))**numpy.min(4,max(0,4-round(math.log10(S))))
...
#-------------------------------------------------------------------------------------------------------------------------
    ...
    UNIT["TJ/kg"] = 1e12
    UNIT["Wh/kg"] = 3600
    UNIT["kWh/kg"] = 3600*1e3
    UNIT["MWh/kg"] = 3600*1e6
    UNIT["GWh/kg"] = 3600*1e9
    UNIT["TWh/kg"] = 3600*1e12
    ...
    UNIT["W/m2/km/year"] = 1
    UNIT["1e-6.W/m2/km/year"] = 1e-6
    UNIT["1e-12.W/m2/km/year"] = 1e-12
    ...
    UNIT["K/m2/km/year"] = 1
    UNIT["1e-6.K/m2/km/year"] = 1e-6
    UNIT["1e-12.K/m2/km/year"] = 1e-12
...
#def add_UNIT_( name, scale):
#    #=========================================================================================================================
#    # adds unit name to the list
#    #-------------------------------------------------------------------------------------------------------------------------
#    global UNIT
#    #-------------------------------------------------------------------------------------------------------------------------------------------------
#    UNIT(1)($+1) = name 		# New unit name
#    UNIT($+1) = scale  		# Store its conversion factor
#    #-------------------------------------------------------------------------------------------------------------------------




#def convert_(Uout, Vin, varargin):
#    #=================================================================================================================================================
#    global UNIT
#    #-------------------------------------------------------------------------------------------------------------------------------------------------
#    if ~isempty(varargin),
...
#def convert_from(FROM,val1):
#    #=========================================================================================================================
#    # converts usual unit (which is declared in FROM) into standard unit
#    #-------------------------------------------------------------------------------------------------------------------------
#    global UNIT
#    #-------------------------------------------------------------------------------------------------------------------------
#    val2 = zeros(val1) 
...
#def [val2,fac] = convert_to(to,val1,varargin):
#    #=========================================================================================================================
#    # converts standard unit into usual unit
#    #-------------------------------------------------------------------------------------------------------------------------
#    global UNIT
#    #-------------------------------------------------------------------------------------------------------------------------
#    
