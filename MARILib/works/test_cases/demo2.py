...
print("")
print("Turbofan nacelle width = ","%.1f"%aircraft.turbofan_nacelle.width," m")
print("Fan BLI thrust factor = ","%.4f"%aircraft.propulsion.bli_thrust_factor," no_dim")
#print("Fan BLI law = ",aircraft.turbofan_nacelle.bnd_layer," no_dim")
